...
<body >
<nav style="background-color: #2E1114; height : 100px " class="navbar navbar-dark ">
    <div class="container-fluid">
    <a class="navbar-brand "><img  src="images/pic1.png" style=" max-width:80px " alt="logo"></a>
	...
	<a class=" btn btn-Danger" aria-current="page" href="login.php">Déconnexion</a>
			...
			<div class="col-6 " style="margin-left:320px" >
		      	<form action="#" method="POST"  enctype='multipart/form-data' class=""style=" text-align: center;background-color:#2E1114;border-radius: 16px; margin-top:50px; height: 690px;" >
				  ...
				  <div class="">
					...
					<div>
					        <select class="form-select "required style="width:350px ;margin-top:20px;margin-left: 176px; height: 40px; border-radius: 10px;border:1px solid ;" class="col-6"  name="Département"  aria-label="Default select example">
                    ...
                    <div>         
					    <select class="form-select" class="" required="required" name="Fonction" class="col-6" style="width:350px;margin-top:20px;margin-left: 176px; height: 40px; border-radius: 10px;border:1px solid" placeholder="Function"  	aria-label="Default select example">
