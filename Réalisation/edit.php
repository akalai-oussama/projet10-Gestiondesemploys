...
?>
			...
			<div class="col-6 " style="margin-left:320px" >
		      	<form action="#" method="POST" class=""style="background-color: #501B1D;border-radius: 16px; text-align: center;margin-top:50px; height: 670px;" enctype='multipart/form-data'>
	            ...
	            <div class="">
	            	<button type="submit" name="update" style="width:350px; background-color:#83677B; border:1px solid black" class="  btn btn-primary submit px-3" >Modiffer</button>
					<a href="index.php" class= "btn btn-Warning  ;" style=" background-color:#ADADAD; border:1px solid black">Retourner</a>
	            </div>
