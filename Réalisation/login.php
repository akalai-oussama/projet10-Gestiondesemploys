...
<div class="col-6 " style="margin-left:320px" >
		      <form action="#" method="POST"  class=""style="background-color:#2E1114;border-radius: 16px; text-align: center;margin-top:50px; height: 450px;" >
			  <img src="images/pic1.png" alt="logo" width="140" class="shadow-light rounded-circle mb-6 mt-3">
