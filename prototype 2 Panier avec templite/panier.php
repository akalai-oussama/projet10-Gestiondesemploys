                ...
                <div class="row main align-items-center">
                    ...
                    <div class="col-2">                            <?php
                            ...
                            while($donnees = $req->fetch()){
                                echo('<img style ="width:200px;" src ="'.$donnees['img'].'"/><br>' );
                                
                            }
                            ?>
                    <div class="col">
                        <div class="row text-muted " style ="margin-left:20px;"><?= $value["nom"] ?></div>
                        
                        <div class="row" style ="margin-left:20px;width:500px">Lorem ipsum dolor sit amet consectetur adipisicing elit.</div>
                    </div>
